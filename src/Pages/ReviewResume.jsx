...
const ReviewResume = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
          ...
          const {data} = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/ai/review-resume`, formData, 
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Only accepts PDF format.</p>
